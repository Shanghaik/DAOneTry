    ...
    public partial class Form_BanHang : Form
    {
        ...
        private void Form_BanHang_Load(object sender, EventArgs e)
        {
            Product p = new Product()
            {
                ...
                Name = "ANC",
                From = "VN",
                ImgURL = "C:\\Users\\Acer\\source\\repos\\DAOneTry\\PRL\\Resources\\Images\\Khoa.png",
                Price = 100000,
                TotalAmount = 100,
                Status = 0,
                Details = "Ngon"
            };
            Panel panel1 = CreateSP(p);
            Panel panel2 = CreateSP(p);
            Panel panel3 = CreateSP(p);
            Panel panel4 = CreateSP(p);
            tlp_Product.Controls.Add(panel1, 0, 0);
            tlp_Product.Controls.Add(panel2, 0, 1);
            tlp_Product.Controls.Add(panel3, 1, 0);
            tlp_Product.Controls.Add(panel4, 1, 1);
        }
    }
}
